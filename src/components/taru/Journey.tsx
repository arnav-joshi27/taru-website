...
const stages = [
  { n: "01", t: "Collect", d: "It begins in the quiet places — fallen leaves, dried fronds, and forgotten fibres gathered with care alongside the farming families who know this land best.", img: g1.url, icon: "❋" },
  { n: "02", t: "Clean & Prepare", d: "Each leaf is washed by hand, laid out under the sun, and gently sorted — a slow ritual that prepares nature's offerings for a second life.", img: g2.url, icon: "❅" },
  { n: "03", t: "Transform", d: "With warmth, patience, and craft passed down through generations, raw plant material becomes something lasting — biodegradable, beautiful, and entirely free of plastic or chemicals.", img: g3.url, icon: "≋" },
  { n: "04", t: "Craft & Share", d: "Skilled artisans shape every piece by hand, weaving heritage into everyday objects — pieces meant to be used, loved, and returned softly to the earth.", img: g4.url, icon: "✋" },
];
