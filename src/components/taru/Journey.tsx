      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-24 md:mb-32 max-w-3xl mx-auto">
          ...
          <p className="text-beige/60 leading-relaxed max-w-lg mx-auto whitespace-pre-line">
            Every product begins as a fallen leaf. Through ethical craftmanship and community-driven production, we turn what was discarded into lasting, biodegradable essentials that honor people, planet and promises a greener future.&nbsp;{"\n\n"}
